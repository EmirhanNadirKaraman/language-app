...
Usage:
    python scripts/validate_tier_lemmas.py                   # all tiers
    python scripts/validate_tier_lemmas.py --tier a1         # one tier only
    python scripts/validate_tier_lemmas.py --verbose         # show all results
