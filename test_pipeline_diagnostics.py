...
from utterance_unit_extractor import UtteranceExtractionResult
...
def _build_pipeline_with_stubs(
    ...
    from exposure_counter import ExposureEvent
...
class TestStageCounts:
    def test_fragments_ingested(self):
        ...
        with patch("pipeline.parse_srt", return_value=frags):
